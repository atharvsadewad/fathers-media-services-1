  ...
  return (
    <footer className="border-t border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 transition-colors">
      <div className="container-responsive py-8 grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div>
          ...
          <ul className="mt-2 space-y-2 text-sm">
            <li><Link href="/" className="text-gray-600 dark:text-gray-300 hover:text-blue-600">Home</Link></li>
            <li><Link href="/about" className="text-gray-600 dark:text-gray-300 hover:text-blue-600">About</Link></li>
            <li><Link href="/services" className="text-gray-600 dark:text-gray-300 hover:text-blue-600">Services</Link></li>
            <li><Link href="/portfolio" className="text-gray-600 dark:text-gray-300 hover:text-blue-600">Portfolio</Link></li>
            <li><Link href="/contact" className="text-gray-600 dark:text-gray-300 hover:text-blue-600">Contact</Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="mt-2 space-y-3 text-sm">
            ...
            <li>
              <a href="https://facebook.com/fathers_media" target="_blank" rel="noreferrer"
            ...
            <li>
              <a href="https://linkedin.com/company/fathers_media" target="_blank" rel="noreferrer"
                className="flex items-center gap-2 text-gray-600 dark:text-gray-300 hover:text-blue-700">
                <Linkedin size={16} /> LinkedIn
              </a>
            </li>
            <li>
              <a href="https://x.com/fathers_media" target="_blank" rel="noreferrer"
                className="flex items-center gap-2 text-gray-600 dark:text-gray-300 hover:text-gray-400">
                <Twitter size={16} /> X
              </a>
            </li>
          </ul>
        ...
        <div>
          ...
          <ul className="mt-2 space-y-3 text-sm">
            <li className="flex items-center gap-2 text-gray-600 dark:text-gray-300">
              <Mail size={16} />
              <a href="mailto:contact@fathersmedia.com">contact@fathersmedia.com</a>
            </li>
            <li>
      ...
      <div className="border-t border-gray-200 dark:border-gray-700">
        <div className="container-responsive py-4 text-xs text-gray-600 dark:text-gray-400 flex items-center justify-between">
